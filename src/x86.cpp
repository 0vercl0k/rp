...
void x86::find_gadget_in_memory(
    ...
    const uint32_t depth, std::multiset<std::shared_ptr<Gadget>> &gadgets, uint32_t disass_engine_option,
    std::mutex &m
)
{
